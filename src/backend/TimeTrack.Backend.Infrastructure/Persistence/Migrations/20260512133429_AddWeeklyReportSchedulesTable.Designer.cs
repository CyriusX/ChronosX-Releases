...
namespace TimeTrack.Backend.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260512133429_AddWeeklyReportSchedulesTable")]
    partial class AddWeeklyReportSchedulesTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TimeTrack.Backend.Domain.Entities.AiDecisionLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<JsonElement?>("CorrectValue")
                        .HasColumnType("jsonb")
                    ...
                    b.HasIndex("WasReviewed", "DecisionType")
                        .HasFilter("was_reviewed = false");

                    b.HasIndex("OrgId", "DecisionType", "CreatedAt")
                        .IsDescending(false, false, true);

                    b.HasIndex("UserId", "DecisionType", "CreatedAt")
                        .IsDescending(false, false, true);

                    b.ToTable("ai_decision_log", (string)null);
                });
            ...
            modelBuilder.Entity("TimeTrack.Backend.Domain.Entities.BehavioralAnomaly", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<JsonElement>("Evidence")
                        .HasColumnType("jsonb")
                    ...
                    b.HasIndex("OrgId", "Severity", "DetectedAt");

                    b.ToTable("behavioral_anomalies", (string)null);
                });
            ...
            modelBuilder.Entity("TimeTrack.Backend.Domain.Entities.DailyFocusScore", b =>
                {
                    ...
                    b.Property<int>("AvgFocusSeconds")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0)
                        .HasColumnName("avg_focus_seconds");

                    b.Property<int>("BrowserSeconds")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0)
                    ...
                    b.Property<int>("ContextSwitchesCount")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0)
                    ...
                    b.Property<int>("DistinctAppsCount")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0)
                    ...
                    b.Property<int>("FocusSessionsCompleted")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0)
                        .HasColumnName("focus_sessions_completed");

                    b.Property<int>("FocusSessionsCount")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0)
                    ...
                    b.Property<int>("LongestFocusSeconds")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0)
                        .HasColumnName("longest_focus_seconds");

                    b.Property<int>("NeutralSeconds")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0)
                    ...
                    b.Property<string>("TopAppExe")
                        .HasMaxLength(512)
                        .HasColumnType("character varying(512)")
                        .HasColumnName("top_app_exe");

                    b.Property<int>("TopAppSeconds")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(0)
            ...
            modelBuilder.Entity("TimeTrack.Backend.Domain.Entities.EvidenceItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("IsDeleted", "CapturedAt");

                    b.HasIndex("OrgId", "CapturedAt");
            ...
            modelBuilder.Entity("TimeTrack.Backend.Domain.Entities.FeatureMonthly", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<double>("AvgFocusScore")
                        .HasColumnType("double precision")
                        .HasColumnName("avg_focus_score");

                    b.Property<double>("AvgProductiveRatio")
                        .HasColumnType("double precision")
                    ...
                    b.Property<double>("TotalActiveHours")
                        .HasColumnType("double precision")
                        .HasColumnName("total_active_hours");

                    b.Property<double?>("TrendFocusScore")
                        .HasColumnType("double precision")
                    ...
                    b.HasIndex("OrgId", "MonthStart");

                    b.HasIndex("UserId", "MonthStart")
                        .IsUnique();

                    b.ToTable("feature_monthly", (string)null);
                });

            modelBuilder.Entity("TimeTrack.Backend.Domain.Entities.FeatureWeekly", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<double>("AvgContextSwitches")
                        .HasColumnType("double precision")
                    ...
                    b.Property<double>("AvgInterruptionCount")
                        .HasColumnType("double precision")
                    ...
                    b.Property<double?>("TrendProductiveRatio")
                        .HasColumnType("double precision")
                    ...
                    b.HasIndex("OrgId", "WeekStart");

                    b.HasIndex("UserId", "WeekStart")
                        .IsUnique();

                    b.ToTable("feature_weekly", (string)null);
                });
            ...
            modelBuilder.Entity("TimeTrack.Backend.Domain.Entities.OrgPolicy", b =>
                {
                    ...
                    b.Property<int>("EvidenceRetentionDays")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasDefaultValue(30)
                    ...
                    b.Property<string>("ScreenshotExcludedAppsJson")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("jsonb")
                    ...
                    b.Property<bool>("WebsiteTrackingEnabled")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("boolean")
            ...
            modelBuilder.Entity("TimeTrack.Backend.Domain.Entities.SmartAlert", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("AlertType", "UserId", "CreatedAt");

                    b.HasIndex("OrgId", "Severity", "CreatedAt");

                    b.HasIndex("UserId", "WasRead", "CreatedAt");

                    b.ToTable("smart_alerts", (string)null);
                });

            modelBuilder.Entity("TimeTrack.Backend.Domain.Entities.StorageKey", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("storage_keys", (string)null);
                });
            ...
            modelBuilder.Entity("TimeTrack.Backend.Domain.Entities.UserPattern", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("UserId", "IsActive", "DetectedAt");

                    b.HasIndex("UserId", "PatternTag", "DetectedAt")
                        .IsUnique();

                    b.ToTable("user_patterns", (string)null);
                });

            modelBuilder.Entity("TimeTrack.Backend.Domain.Entities.WeeklyReportSchedule", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("IsEnabled", "DayOfWeek");

                    b.ToTable("weekly_report_schedules", (string)null);
                });
