 ...
 * - Acesso a páginas de manutenção e administração de plataforma
 * - Bypass verificação de assinatura/pagamento
 *
 * SOLID:
...
export function usePermissions() {
  ...
  /**
   * Verifica se o usuário é Platform Admin (sysAdmin)
   * Platform Admins têm acesso a funções de administração de plataforma
   * como monitoramento de saúde, eventos de plataforma, etc.
   */
  const isPlatformAdmin = (): boolean => user?.isPlatformAdmin === true;
