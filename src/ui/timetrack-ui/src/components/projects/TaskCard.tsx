 ...
 * user is the assignee. Other cards are visible but locked.
 */

import { useSortable } from '@dnd-kit/sortable';
import { CSS } from '@dnd-kit/utilities';
import { Clock, User, Calendar, PlayCircle, Lock } from 'lucide-react';
...
export function TaskCard({
  ...
  return (
    <div
      ...
      {...(draggable ? listeners : {})}
      className={`bg-[rgba(26,29,46,0.8)] border border-[rgba(255,255,255,0.06)] rounded-lg p-3 transition-colors ${
        draggable
          ? 'cursor-grab active:cursor-grabbing hover:border-[rgba(255,255,255,0.12)]'
