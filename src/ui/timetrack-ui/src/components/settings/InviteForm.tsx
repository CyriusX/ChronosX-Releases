      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div className="grid grid-cols-2 gap-4">
          <div>
            ...
            <input
              ...
              className="w-full bg-[rgba(255,255,255,0.04)] border border-[rgba(255,255,255,0.08)] rounded-lg px-3 py-2 text-[13px] text-[#f5f7fb] placeholder:text-[rgba(245,247,251,0.3)] focus:outline-none focus:border-[#4ad9ff]"
              required
            />
          </div>
          <div>
        ...
        <div className="flex justify-end gap-2 pt-2">
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 bg-gradient-to-r from-[#4ad9ff] to-[#3c7bff] rounded-lg text-[13px] font-medium text-white hover:opacity-90 transition-opacity disabled:opacity-50"
          >
