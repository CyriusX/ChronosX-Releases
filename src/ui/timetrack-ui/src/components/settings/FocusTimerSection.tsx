    ...
    <div>
      ...
      <div className="flex items-center gap-2">
        <input
          ...
          min={min}
          max={max}
          className="w-full px-3 py-2 bg-[rgba(255,255,255,0.04)] border border-[rgba(255,255,255,0.06)] rounded-lg text-[13px] text-[#f5f7fb] focus:outline-none focus:border-[rgba(139,92,246,0.3)] transition-colors [appearance:textfield] [&::-webkit-outer-spin-button]:appearance-none [&::-webkit-inner-spin-button]:appearance-none"
        />
